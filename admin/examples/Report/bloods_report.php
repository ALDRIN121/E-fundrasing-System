                ...
                <div class="row">
                        ...
                        <div class="card card-chart">
                            ...
                            <div class="card-body">
                                <div class="chart-area">
                                    <?php echo "<h3> Frequently Requested For </h3><br> <div class = 'h3'><h3 style='text-align: center;'>" . $rowcount2['blood'] . "</h3></div> "
                                    ?>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-chart">
                            ...
                            <div class="card-body">
                                <div class="chart-area">
                                    <?php echo "<h3> Most donated  for</h3><br> <div class = 'h3'><h3 style='text-align: center;'>" . $rowcount8['blood']. "</h3></div> "
                                    ?>
                                </div>
                            </div>
                            <div class="card-footer">
