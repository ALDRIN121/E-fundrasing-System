                ...
                <div class="card text-center bg-info">
                    ...
                    <div class="card-body">
                        <div class="chart-area">
                            <h3>Total no of transactions</h3><br>
                            <div class='h3'>
                                <?php echo "<h3 style='text-align: center;'>".$rowcount."</h3>"; ?>
                            </div>
                            <a href="money_transacion_report.php" class="btn btn-primary btn-lg">More info</a>
                        </div>
                ...
                <div class="card text-center bg-info">
                    ...
                    <div class="card-body">
                        <div class="chart-area">
                            ...
                            <a href="money_request_report.php" class="btn btn-primary btn-lg">More info</a>
                        </div>
