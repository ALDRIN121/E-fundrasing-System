    ...
    -->
        ...
        <div class="main-panel" id="main-panel">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Verification Table</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <?php
                                        $result = mysqli_query($con, "SELECT * FROM hospital_register");
                                        ?>
                                        <?php
                                        $i = 0;
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="../../../image/<?php echo $row['photo'] ?>" target="_blank"><button type="button" class="btn btn-primary">View File</button></a></td>
                                            </tr>
                                        <?php
                                            $i++;
                                        }
            ...
            <div class="card">
              ...
              <form class="form-inline" method="POST" action="php/verification.php">
                
                <div class="form-group mx-sm-3 mb-2">
                  <label for="inputPassword2" class="sr-only">ID no</label>
